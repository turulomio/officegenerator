...
from officegenerator.libodfgenerator import ODS_Read, ODS_Write, ODT_Manual_Styles, ODT_Standard,  OdfCell, ColumnWidthODS, ODT, rewrite_ods_through_libreoffice
from officegenerator.libxlsxgenerator import XLSX_Write, XLSX_Read, create_data_only_xlsx, rewrite_xlsx_through_libreoffice
...
def main(arguments=None):
    ...
    if args.remove==True:
        ...
        remove_without_errors("officegenerator.rewritten.ods")
        ...
        remove_without_errors("officegenerator.rewritten.xlsx")
...
def demo_xlsx_data_only():
    start=datetime.now()   
    filename_data_only=create_data_only_xlsx("officegenerator.xlsx")
    ...
    doc=XLSX_Read(filename_data_only)
    output.write(str(doc.getCellValue(0, "C25"))+"\n")
